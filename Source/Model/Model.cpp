...
//
//        // 1. diffuse maps
//    std::vector<TextureInfo> diffuseMaps = loadMaterialTextures(mMaterial, aiTextureType_DIFFUSE, "texture_diffuse");
//    textures.insert(textures.end(), diffuseMaps.begin(), diffuseMaps.end());
//    // 2. specular maps
//    std::vector<TextureInfo> specularMaps = loadMaterialTextures(mMaterial, aiTextureType_SPECULAR, "texture_specular");
//    textures.insert(textures.end(), specularMaps.begin(), specularMaps.end());
//    // 3. normal maps
//    std::vector<TextureInfo> normalMaps = loadMaterialTextures(mMaterial, aiTextureType_HEIGHT, "texture_normal");
//    textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
//    // 4. height maps
//    std::vector<TextureInfo> heightMaps = loadMaterialTextures(mMaterial, aiTextureType_AMBIENT, "texture_height");
